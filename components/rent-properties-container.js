...
const RentPropertiesContainer = () => {
  return (
    <div className="flex flex-col items-center justify-start gap-[39px] px-0 py-[86px] text-center font-body-regular-600 text-21xl text-primary-800">
      <div className="flex max-w-[95%px] flex-col items-center justify-start gap-[40px] md:box-border md:pl-[60px] md:pr-[60px]">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-[32px] px-2.5 py-0">
          <PropertyCard
