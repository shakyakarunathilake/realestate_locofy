...
const FeatureContainer = () => {
  return (
    <div className="flex flex-col items-center justify-start bg-primary-50 px-0 py-[70px] text-center font-body-regular-600 text-21xl text-primary-800">
      <div className="box-border flex max-w-[95%px] flex-col items-center justify-start gap-[54px] px-0 pb-0 pt-[75px]">
        <div className="box-border flex max-w-[95%px] flex-col items-center justify-start gap-[24px] px-[30px] py-0">
